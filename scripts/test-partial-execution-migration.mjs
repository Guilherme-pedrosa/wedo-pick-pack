...
try {
  ...
  await db.query(`INSERT INTO partial_writeoff_operations(id,budget_id,budget_code,client_id,client_name,document_type,status,budget_snapshot)
    VALUES($1,'budget','4784','client','Cliente','os','ready_to_consolidate','{}')`,[op]);
