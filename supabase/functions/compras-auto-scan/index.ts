...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    return Response.json(
      {
        error: "Não foi possível consultar a última varredura de compras. Nenhuma nova varredura foi iniciada.",
        scan_started: false,
      },
...
// Publicação manual: consulta do último resultado de compras, 14/09/2026.
