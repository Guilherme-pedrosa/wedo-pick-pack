...
export default function ToolboxHandoffReceipt({
  open,
  onClose,
  toolboxName,
  technicianName,
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      ...
      <html>
      <head>
        <title>Minuta - ${toolboxName}</title>
        <style>
    ...
    <Dialog open={open} onOpenChange={() => onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          <div ref={printRef} className="bg-white text-black p-4 rounded border border-border text-xs">
            {/* Company Header */}
            ...
            <div style={{ textAlign: "center", marginBottom: "16px" }}>
              <h1 style={{ fontSize: "16px", fontWeight: 700, marginBottom: "4px", textTransform: "uppercase", letterSpacing: "1px" }}>
                Minuta de Maleta de Ferramentas
              </h1>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px", marginBottom: "16px", padding: "10px", background: "#f5f5f5", borderRadius: "4px" }}>
              ...
              <div>
                <label style={{ fontSize: "10px", color: "#888", textTransform: "uppercase", letterSpacing: "0.5px", display: "block" }}>Maleta</label>
                <span style={{ fontSize: "12px", fontWeight: 600 }}>{toolboxName}</span>
              </div>
              <div>
                <label style={{ fontSize: "10px", color: "#888", textTransform: "uppercase", letterSpacing: "0.5px", display: "block" }}>Data</label>
            ...
            <div style={{ border: "1px solid #ccc", borderRadius: "4px", padding: "14px", marginBottom: "16px" }}>
              ...
              <p style={{ fontSize: "10px", lineHeight: 1.6, color: "#444", marginBottom: "6px" }}>
                Ao receber esta maleta de ferramentas, o técnico assume total responsabilidade pelas ferramentas e itens nela contidos.
              </p>
              <p style={{ fontSize: "10px", lineHeight: 1.6, color: "#444", marginBottom: "6px" }}>
                Em caso de perda, extravio, dano ou desaparecimento, deverá ressarcir integralmente o valor da ferramenta constante nesta minuta.
              </p>
              <p style={{ fontSize: "10px", lineHeight: 1.6, color: "#444", marginBottom: "6px" }}>
                Caso empreste, transfira ou permita o uso da maleta por outro técnico ou terceiro, sem autorização expressa da direção, continuará sendo o responsável por qualquer perda, dano ou uso indevido.
              </p>
              <p style={{ fontSize: "10px", lineHeight: 1.6, color: "#444" }}>
                Não é necessária assinatura, pois o técnico foi verbalmente avisado e manteve uma cópia desta minuta.
              </p>
            </div>
