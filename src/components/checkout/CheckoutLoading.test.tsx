...
const m = vi.hoisted(() => {
  ...
  return { getOS: vi.fn(), getVenda: vi.fn(), enrich: vi.fn(), findPartial: vi.fn(), stockGuard: vi.fn(), updateOS: vi.fn(), updateVenda: vi.fn(), confirmPartial: vi.fn(), save: vi.fn(), error: vi.fn(), mobile: false };
});
