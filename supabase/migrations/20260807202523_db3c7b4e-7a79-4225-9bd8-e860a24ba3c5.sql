...
BEGIN
  ...
  -- Bloqueia apenas quando algo ja foi efetivado no GestaoClick
  IF EXISTS (
  ...
  -- Bloqueia quando pecas ja sairam fisicamente
  IF EXISTS (
  ...
  -- Cancela lotes pendentes e libera reservas internas
